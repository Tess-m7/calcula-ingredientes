...
export const recipes: Recipe[] = [
  ...
  baseServings: 1,
  image: '/images/2-BUDIN.jpg', // Nombre del archivo de la imagen
  ingredients: [
    ...
    { name: 'Laurel', quantity: 0.1, unit: 'hoja por porción' }
  ],
  steps: [
  ...
  baseServings: 1,
  image: '/images/3-CARBONADA.jpg', // Asegúrate de tener esta imagen en tu carpeta 'images'
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/4-CARNE-PORTUGUESA.jpg', // Asegúrate de tener esta imagen en la carpeta 'images'
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/5-CAZUELA-LENTEJAS.jpg', // Ajusta el nombre de la imagen si es diferente
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/6-CHOPSUEY.jpg', // Ajusta el nombre de la imagen según tu carpeta
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/CHUPIN-PESCADO.jpg', // Ajusta el nombre de la imagen según tu carpeta
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/7-CROQUETAS.jpg', // Ajusta según el nombre del archivo de imagen
  ingredients: [
  ...
  baseServings: 11,
  image: '/images/8-ENSALADA-POLLO.jpg', // Ajusta el nombre de la imagen según corresponda
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/9-ENSALADA-ATUN.jpg', // Ajusta el nombre del archivo de imagen
  ingredients: [
    { name: 'Arroz', quantity: 40, unit: 'g' },
    { name: 'Lentejas', quantity: 20, unit: 'g' },
    { name: 'Atún', quantity: 60, unit: 'g' },
  ...
  baseServings: 1,
  image: '/images/10-HAMBURGUESA-ATUN.jpg', // Ajusta el nombre del archivo de imagen
  ingredients: [
    { name: 'Pescado', quantity: 60, unit: 'g' },
  ...
  name: 'Lasaña',
  baseServings: 1,
  image: '/images/11-LASAÑA.jpg', // Nombre del archivo de la imagen, ajusta según corresponda
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/12-PAN-CARNE.jpg', // Nombre del archivo de la imagen, ajusta si es necesario
  ingredients: [
  ...
  name: 'Pasta sorpresa',
  baseServings: 1,
  image: '/images/13-PASTA-SORPRESA.jpg', // Nombre del archivo de la imagen, ajusta si es necesario
  ingredients: [
    { name: 'Suprema de pollo', quantity: 50, unit: 'g' },
    ...
    { name: 'Aceite', quantity: 10, unit: 'ml' },
    { name: 'Albahaca (se calcula 1 atado para 25 comensales)', quantity: 0.04, unit: 'atado por porción' },
    { name: 'Sal', quantity: 0.5, unit: 'g' },
    { name: 'Ajo', quantity: 1, unit: 'g' },
    { name: 'Perejil', quantity: 1, unit: 'g' }
  ],
  ...
  baseServings: 1,
  image: '/images/14-PASTA-VERDUSALSA.jpg', // Ajusta el nombre del archivo de imagen según corresponda
  ingredients: [
    { name: 'Carne picada o en cubos', quantity: 50, unit: 'g' },
    { name: 'Pulpa de tomate', quantity: 40, unit: 'g' },
    { name: 'Cebolla', quantity: 10, unit: 'g' },
    ...
    { name: 'Pimentón', quantity: 0.05, unit: 'g' },
    { name: 'Laurel', quantity: 0.04, unit: 'hoja por porción' },
    { name: 'Aceite', quantity: 5, unit: 'ml' }
  ],
  steps: [
  ...
  baseServings: 1,
  image: '/images/15-PASTEL-CARNE.jpg', // Ajusta el nombre del archivo de imagen
  ingredients: [
  ...
  name: 'Pollo colorido',
  baseServings: 1,
  image: '/images/16-POLLO-COLORIDO.jpg', // Ajusta el nombre del archivo de imagen
  ingredients: [
    { name: 'Suprema de pollo', quantity: 50, unit: 'g' },
    { name: 'Cebolla', quantity: 10, unit: 'g' },
    { name: 'Morrón', quantity: 15, unit: 'g' },
  ...
  baseServings: 1,
  image: '/images/17-PASTEL-BERENJENAS.jpg', // Ajusta el nombre del archivo de la imagen
  ingredients: [
    { name: 'Carne picada', quantity: 50, unit: 'g' },
  ...
  baseServings: 1,
  image: '/images/POLLO-SALSA-BLANCA.png', // Ajusta el nombre del archivo de la imagen
  ingredients: [
    { name: 'Suprema de pollo', quantity: 50, unit: 'g' },
  ...
  baseServings: 1,
  image: '/images/18-TORTA-CARNE.jpg', // Ajusta el nombre del archivo de la imagen
  ingredients: [
    { name: 'Carne picada', quantity: 60, unit: 'g' },
    { name: 'Cebolla', quantity: 10, unit: 'g' },
    { name: 'Morrón', quantity: 15, unit: 'g' },
    ...
    { name: 'Almidón de maíz', quantity: 2, unit: 'g' },
    { name: 'Sal', quantity: 0.5, unit: 'g' },
    { name: 'Hierbas o condimentos', quantity: 0.1, unit: 'g' }
  ],
  steps: [
  ...
  baseServings: 1,
  image: '/images/19-TORTILLA.jpg', // Ajusta el nombre de la imagen
  ingredients: [
    { name: 'Papa', quantity: 160, unit: 'g' },
    { name: 'Zapallito', quantity: 50, unit: 'g' },
    { name: 'Suprema de pollo', quantity: 50, unit: 'g' },
  ...
  name: 'Torta de atún',
  baseServings: 1,
  image: '/images/20-TORTA-ATUN.jpg', // Ajusta el nombre de la imagen
  ingredients: [
    { name: 'Atún', quantity: 60, unit: 'g' },
    { name: 'Cebolla', quantity: 20, unit: 'g' },
    { name: 'Morrón', quantity: 15, unit: 'g' },
  ...
  name: 'Arroz',
  baseServings: 1,
  image: '/images/21-ARROZ.jpg', // Ajusta el nombre del archivo según tengas
  ingredients: [
    { name: 'Arroz', quantity: 40, unit: 'g' },
  ...
  name: 'Fideos',
  baseServings: 1,
  image: '/images/22-FIDEOS.jpg', // Ajusta el nombre según la imagen que tengas
  ingredients: [
    { name: 'Fideos', quantity: 40, unit: 'g' },
  ...
  baseServings: 1,
  image: '/images/23-ARROZ-SALTEADO.jpg', // Ajusta el nombre según tu archivo de imagen
  ingredients: [
    { name: 'Arroz', quantity: 40, unit: 'g' },
  ...
  name: 'Arroz amarillo',
  baseServings: 1,
  image: '/images/24-ARROZ-AMARILLO.jpg', // Ajusta el nombre de la imagen según tu archivo
  ingredients: [
    { name: 'Arroz', quantity: 40, unit: 'g' },
    { name: 'Cebolla', quantity: 10, unit: 'g' },
    { name: 'Ajo', quantity: 0.5, unit: 'g' },
  ...
  baseServings: 1,
  image: '/images/25-ENSALADA-VEGETALES.jpg', // Ajusta el nombre de la imagen según tu archivo
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/26-JARDINERA.jpg', // Ajusta el nombre del archivo si es necesario
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/27-JARDINERA.jpg', // Ajusta el nombre del archivo si es necesario
  ingredients: [
    { name: 'Arroz', quantity: 30, unit: 'g' },
    { name: 'Choclo', quantity: 15, unit: 'g' },
    { name: 'Zanahoria', quantity: 40, unit: 'g' },
  ...
  baseServings: 1,
  image: '/images/28-ENSALADA-LEGUMINOSAS.jpg', // Ajusta el nombre del archivo si es necesario
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/PAPAS-NATURAL.jpg', // Ajusta el nombre del archivo si es necesario
  ingredients: [
    { name: 'Papa', quantity: 160, unit: 'g' },
    { name: 'Aceite', quantity: 5, unit: 'ml' },
    { name: 'Sal', quantity: 0.25, unit: 'g' }
  ...
  name: 'Puré de papas',
  baseServings: 1,
  image: '/images/PURE-PAPAS.jpg', // Ajusta el nombre del archivo si es necesario
  ingredients: [
    { name: 'Papa', quantity: 160, unit: 'g' },
  ...
  name: 'Puré triple',
  baseServings: 1,
  image: '/images/31-PURE-TRIPLE.jpg', // Ajusta el nombre de la imagen si es necesario
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/32-PURE-INSTANTANEO.jpg', // Ajusta el nombre de la imagen si es necesario
  ingredients: [
...
},
{
  ...
  baseServings: 1,
  image: '/images/33-HORTALIZAS-ASADAS.jpg', // Ajusta el nombre de la imagen según tu archivo
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/34-SALSA-BLANCA.jpg', // Ajusta el nombre de la imagen según tu archivo
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/35-ARROZ-PRINCIPAL.jpg', // Ajusta el nombre de la imagen según tu archivo
  ingredients: [
  ...
  baseServings: 1,
  image: '/images/36-FIDEOS-PRINCIPAL.jpg', // Ajusta el nombre de la imagen según tu archivo
  ingredients: [
